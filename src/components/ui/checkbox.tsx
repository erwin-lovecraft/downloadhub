...
// The `data-disabled:` variants are not redundant with the `disabled:`
// ones: base-ui renders the root as a <span role="checkbox">, and the
// `:disabled` pseudo-class only ever matches real form elements, so the
// `disabled:` variants alone leave a disabled checkbox looking enabled.
